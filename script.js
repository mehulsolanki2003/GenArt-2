...
async function updateUIForAuthState(user) {
    if (user) {
        ...
        DOMElements.historyLink?.classList.remove("hidden");
        DOMElements.mobileHistoryLink?.classList.remove("hidden");
        ...
        DOMElements.historyLink?.classList.add("hidden");
        DOMElements.mobileHistoryLink?.classList.add("hidden");

        // ✅ Reset buttons to "Sign In"
